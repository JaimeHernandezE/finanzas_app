...
Solo OAuth de usuario (Google Cloud: cliente OAuth + refresh token con alcance Drive).

Uso (GitHub Actions o local):
  export DATABASE_URL=...
  export GOOGLE_DRIVE_OAUTH_REFRESH_TOKEN=...
  export GOOGLE_DRIVE_OAUTH_CLIENT_ID=...
