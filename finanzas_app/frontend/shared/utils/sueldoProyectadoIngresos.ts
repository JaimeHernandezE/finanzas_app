import { CATEGORIA_INGRESO_DECLARADO_FONDO_COMUN } from '../constants/ingresoComun'
 ...
 * Excluye el ingreso espejo de {@link IngresoComun}: PK en `ingreso_comun` o categoría declarada.
 */
