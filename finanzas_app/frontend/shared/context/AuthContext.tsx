// NOTA: Este contexto usa APIs web (useNavigate, localStorage, signInWithPopup).
// Para la app mobile, crear una implementación equivalente en
// mobile/context/AuthContext.tsx usando useRouter (expo-router) y SecureStore.
