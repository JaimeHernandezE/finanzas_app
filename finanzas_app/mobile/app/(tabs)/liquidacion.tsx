...
function normalizarLiquidacion(raw: unknown): ResumenLiquidacion {
  const data = (raw ?? {}) as Partial<ResumenLiquidacion> & { miembros?: MiembroLiquidacion[] | null }
  return {
    total_gastos_comunes: typeof data.total_gastos_comunes === 'number' ? data.total_gastos_comunes : 0,
...
export default function LiquidacionScreen() {
  ...
  const cargar = useCallback(async () => {
    ...
    try {
      ...
      setData(normalizarLiquidacion(res.data))
    } catch (err: unknown) {
